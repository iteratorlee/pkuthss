...
% 设定文档的基本信息。
\pkuthssinfo{
	cthesisname = {博士研究生学位论文开题报告}, ethesisname = {Ph.D. Proposal Thesis},
	thesiscover = {博士研究生学位论文开题报告},
	% 长标题可用 \newline 强制换行，不能用“\\”（双盲版会出错）。
	ctitle = {云环境下深度学习应用优化技术研究},
	etitle = {Research on Optimization of Deep Learning Applications in Cloud Environment},
	cauthor = {李炎}, eauthor = {Yan Li}, date = {二〇二二年五月},
	studentid = {2001111305}, school = {计算机学院},
	cmajor = {计算机软件与理论}, emajor = {Computer Software and Theory},
	direction = {云计算与普适计算},
	cmentor = {梅宏}, ementor = {Prof.\ Hong Mei},
	ckeywords = {云原生，深度学习，性能分析，性能优化},
	ekeywords = {Cloud Native , Deep Learning, Performance Analysis, Performance Optimization},
	% 以下两项无双盲评审需求的用户可保持原状。
