...
此后类似的架构在产业界得到了广泛使用。直到2014年，M. Li等人\parencite{186214}在OSDI上发表论文，综合地描述了PS Model的设计和实现，并完善了PS Model的通信模型、参数同步和异步的push/pull模型、server节点的一致性模型。至此，PS Model实际上已经开始逐渐称为业界大型分布式机器学习系统的设计范式。
