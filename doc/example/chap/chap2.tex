...
J. Carreira等人\parencite{carreira2019cirrus}在2020年提出了Cirrus，一个基于serverless的支持一站式ML工作流的框架。其支持了数据预处理、模型训练、模型调优等ML工作流中的关键阶段，并为用户提供了友好的FaaS风格的API。与前两个工作类似，Cirrus也采取PS模型作为整个系统的基础框架。图~\ref{cirrus_arch}描述了Cirrus的系统架构
